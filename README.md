...
- 人脸注册：新增人员时选择人脸图片生成注册特征，编辑人员时也可以选择新图片追加人脸特征。
...
- `ui/RegisterDialog`：人员信息编辑弹窗，收集姓名、学号、部门和可选人脸图片路径。
...
3. 点击“新增”，填写姓名、学号和部门，并选择一张包含清晰正脸的人脸图片。
4. 在人员信息管理界面中，可以通过关键字查询人员，也可以选择人员后进行编辑或删除。
5. 关闭管理界面后，主界面的人员列表会刷新。
6. 点击“导入图片”，选择待识别图片。
7. 点击“开始识别”，系统会检测图片中的人脸并显示识别姓名和相似度。
8. 点击“开始摄像头”，系统会读取默认摄像头并进行实时检测和识别。
9. 识别记录会显示在右侧日志区域，并写入本地 SQLite 数据库。
...
- `face_features`：人员对应的人脸特征，通过学号关联人员，特征向量以 JSON 数组形式保存。
